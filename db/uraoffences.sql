...
--
-- Host: localhost
-- Generation Time: Oct 31, 2014 at 09:25 AM
...
(7, 'BUSULWA', 'IVAN', 'bivan', 'aea174f1f08068df034e1cee3d02fb82', 'UGBST', '+256 786 329 374', 'ivabusulwa@ura.go.ug', NULL, 'Regional Supervisor', 'Mubende', '2014-07-19 12:30:05'),
...
INSERT INTO `tbl_challenges` (`challngID`, `challenge`, `stationID`, `op_undertaken`, `recordedBy`, `daterecorded`, `summary`) VALUES
(1, 'It has been very hard', 'UGBST', 'Rescued hundreds of items', 7, '2014-08-12', 'Complexity in chasing the offenders');
...
(2, 'UGBST', '2014-07-13', 0, 0, 'C09988', 'BSTM/OFF/07/14/005', 0, 'ASERU JAOYCE', 'OUT RIGHT SMUGGLING', '300', 0, 'SURVEILANCE', 'BUS', 7000, '6483930030894', 1, 'Pending', 4),
...
(11, 'UGBST', '2014-08-06', 1, 1, 'C98040', NULL, 1, 'BRIDGET NAMPIIMA', 'MISDECLARATION', '3000', 1, 'CHECK POINT SEARCH', 'FUSO TRUCK', 8794, '974JDOIDKJUF', 0, 'PENDING', 4),
(12, 'UGBST', '2014-08-27', 0, 100, 'CE348', 'UGBST/C37/08/2014-002', 0, 'BIRUNGI OLIVER', 'UNDER VALUATION', '5', 0, 'AMBUSH', 'TAXI', 3400, 'URTONNF', 0, 'RELEASED', 4),
(14, 'UGBST', '2014-08-30', 0, 100, '78UF', 'UGBST/C37/08/2014-003', 0, 'BENON PAUL', 'OUT RIGHT SMUGGLING', '87', 1, 'AMBUSH', 'FUSO TRUCK', 8900, 'HU383903MFD', 0, 'PENDING', 4),
(15, 'UGBST', '2014-09-02', 0, 100, 'FR3849', 'UGBST/C37/09/2014-005', 0, 'YEWRW', 'OUT RIGHT SMUGGLING', '93', 1, 'AMBUSH', 'FUSO TRUCK', 1230, '78494', 0, 'PENDING', 4),
(16, 'UGBST', '2014-09-01', 0, 100, '785', 'UGBST/C37/09/2014-007', 0, 'OKIROR BRIAN', 'MISDECLARATION', '23', 0, 'CHECK POINT SEARCH', 'TAXI', 1230, 'NGRHUR859958', 0, 'PENDING', 4),
(17, 'UGBST', '2014-09-26', 0, 100, 'CC', 'UGBST/C37/09/2014-008', 0, 'SAM', 'OUT RIGHT SMUGGLING', '199', 1, 'DOCUMENT CHECK', 'BUS', 22, '12334', 0, 'PENDING', 4),
(18, 'UGBST', '2014-09-26', 0, 100, '678NM', NULL, 1, 'MAJID MUSISI', 'OUT RIGHT SMUGGLING', '5', 0, 'CHECK POINT SEARCH', 'FUSO TRUCK', 6577, '76888929', 0, 'PENDING', 4);
