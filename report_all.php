      ...
      <table cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><span id="sprydate1">
            <input name="date1" type="text" disabled="disabled" id="date1" value="<?php if(isset($_POST['date1'])&&strlen($_POST['date1'])>0)echo $_POST['date1'];?>" size="12" />
          ...
          <td><span id="sprydate2">
            ...
            <input name="date2" type="text" disabled="disabled" id="date2" value="<?php if(isset($_POST['date2'])&&strlen($_POST['date2'])>0) echo $_POST['date2'];?>" size="12" />
            <span class="textfieldInvalidFormatMsg">Invalid format.</span><span class="textfieldRequiredMsg">date is required.</span></span></td>
          <td>&nbsp;</td>
