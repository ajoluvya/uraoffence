  ...
  <form id="frm_insert" name="frm_insert" method="get" action="">
    <table cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>&nbsp;</td>
        <td><label for="month2">Month:</label></td>
        <td><input name="filter" type="radio" id="ftl" value="ftl" checked="checked" /></td>
        ...
        <td>&nbsp;</td>
        <td>From:</td>
        <td><input type="radio" name="filter" id="dtr" value="dtr" /></td>
        <td><span id="sprydate1">
        <input name="date1" type="text" disabled="disabled" id="date1" value="<?php if(isset($_GET['date1'])&&strlen($_GET['date1'])>0)echo $_GET['date1'];?>" size="12" />
        <span class="textfieldInvalidFormatMsg">Invalid format.</span><span class="textfieldRequiredMsg">date is required.</span></span></td>
        <td><label for="date3">To:</label></td>
        <td><span id="sprydate2">
          <input name="date2" type="text" disabled="disabled" id="date2" value="<?php if(isset($_GET['date2'])&&strlen($_GET['date2'])>0) echo $_GET['date2'];?>" size="12" />
          <span class="textfieldInvalidFormatMsg">Invalid format.</span><span class="textfieldRequiredMsg">date is required.</span></span></td>
        <td>&nbsp;</td>
        <td><input type="submit" name="btn" id="btn" value="SEARCH" /></td>
      </tr>
    </table>
  </form>
